...
export function DropZone({ onFiles, compact = false }: DropZoneProps) {
  ...
  return (
    ...
    >
      ...
      {!compact && <div className="drop-formats">IPT · IAM · CATPART · CATPRODUCT · SLDPRT · SLDASM · DWG · STEP · IFC · GLB</div>}
    </div>
  );
}
      ...
      <section className="cta-section" id="contact">
        <div className="page-width cta-inner">
          <div>
            ...
            <h2>Need Inventor, CATIA or SolidWorks file-reading support?</h2>
