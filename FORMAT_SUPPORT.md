...
| `.step`, `.stp` | STEP (ISO 10303) | Autodesk Fusion and most mechanical CAD systems | Yes | Open | Current bundled MIT-licensed `step-file-format` streaming browser worker for dependency-free AP203/AP214/AP242 assemblies, materials, wireframes, annotations, saved default views and tessellation |
