...
| `.prt` | NX part, assembly or drawing; also an unrelated Creo part format | Siemens NX / NX MCD or PTC Creo, depending on file origin | Yes (NX) | Closed | Current MIT-licensed `simaticnx-file-format` reader for modern SPLM and legacy CFB NX containers, embedded JT 9.x display geometry, sibling-reference resolution, metadata, diagnostics and previews. Creo PRT and JT 10.x data are not supported |
