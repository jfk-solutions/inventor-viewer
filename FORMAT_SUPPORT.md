...
| `.fcstd` | FreeCAD document | FreeCAD | Yes | Open | Current format-triggered ZIP/XML reader plus lazy OpenCascade BREP tessellation; [FreeCAD](https://github.com/FreeCAD/FreeCAD) source |
