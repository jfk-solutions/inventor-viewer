...
| `.3dm` | Rhino 3D Model | Rhinoceros 3D; also an Onshape export format | No | Closed | Official [openNURBS](https://github.com/mcneel/opennurbs) and [rhino3dm](https://github.com/mcneel/rhino3dm) read/write libraries |
...
| `.bim` | Dotbim | Open BIM tools using the dotbim format | No | Open | Public [dotbim specification and libraries](https://github.com/paireks/dotbim) |
...
| `.brep` | Open CASCADE B-Rep | Open CASCADE and compatible CAD tools | No | Open | [Open CASCADE Technology](https://github.com/Open-Cascade-SAS/OCCT), already used by the viewer for STEP |
| `.bvh` | Biovision Hierarchy animation | Motion-capture and animation tools | No | Open | [Three.js BVHLoader](https://github.com/mrdoob/three.js/blob/dev/examples/jsm/loaders/BVHLoader.js) and [Assimp](https://github.com/assimp/assimp) |
...
| `.f3d` | Fusion design archive | Autodesk Fusion Design | No | Closed | [Official Autodesk export documentation](https://help.autodesk.com/view/fusion360/ENU/?contextId=TPD-DESIGN-EXPORT); no dependable complete open-source reader identified |
| `.f3z` | Fusion distributed-design archive | Autodesk Fusion assemblies and externally referenced designs | No | Closed | Compressed package containing F3D designs and resources; standard archive tools can inspect the package, but no dependable complete open-source F3D reader was identified |
...
| `.fcstd` | FreeCAD document | FreeCAD | No | Open | [FreeCAD](https://github.com/FreeCAD/FreeCAD) source; FCStd is a ZIP/XML-based native document |
...
| `.gcode` | Machine toolpath | CNC machines and 3D-printer slicers | No | Open | [Three.js GCodeLoader](https://github.com/mrdoob/three.js/blob/dev/examples/jsm/loaders/GCodeLoader.js); dialects vary by machine and slicer |
...
| `.ifc` | Industry Foundation Classes | buildingSMART BIM ecosystem | No | Open | [IfcOpenShell](https://github.com/IfcOpenShell/IfcOpenShell) or browser-oriented [web-ifc](https://github.com/ThatOpen/engine_web-ifc) |
| `.iges`, `.igs` | IGES | Mechanical CAD interchange | No | Open | [Open CASCADE Technology](https://github.com/Open-Cascade-SAS/OCCT), already used by the viewer for STEP |
...
| `.ldr`, `.mpd` | LDraw model / multipart document | LDraw LEGO CAD ecosystem | No | Open | [Three.js LDrawLoader](https://github.com/mrdoob/three.js/blob/dev/examples/jsm/loaders/LDrawLoader.js) |
...
| `.md2`, `.md3` | Quake model | id Software game tooling | No | Open | [Assimp](https://github.com/assimp/assimp/blob/master/doc/Fileformats.md); Three.js also provides an MD2 loader |
...
| `.off` | Object File Format | Geomview and geometry-processing tools | No | Open | [Assimp](https://github.com/assimp/assimp/blob/master/doc/Fileformats.md) importer |
...
| `.pmd`, `.pmx` | MikuMikuDance model | MikuMikuDance | No | Open | [Three.js MMDLoader](https://github.com/mrdoob/three.js/blob/dev/examples/jsm/loaders/MMDLoader.js); [Assimp](https://github.com/assimp/assimp) supports PMX |
