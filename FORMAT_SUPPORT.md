...
| `.asm` | Solid Edge or Creo assembly | Siemens Solid Edge or PTC Creo, selected by native container signature | Yes | Closed | The current readers identify native content from bytes rather than trusting the shared extension. `solidedge-file-format` resolves Solid Edge occurrence transforms, references, child appearances, properties and diagnostics through its workspace API; `creo-file-format` handles Creo PSB assemblies |
...
| `.par` | Solid Edge part | Siemens Solid Edge | Yes | Closed | Current MIT-licensed `solidedge-file-format` reader for native CFB documents, saved display-cache tessellation, native styles, properties, saved views, feature names, selection provenance, model bounds and Parasolid payload metadata |
...
| `.psm` | Solid Edge sheet-metal part | Siemens Solid Edge | Yes | Closed | Current MIT-licensed `solidedge-file-format` reader for native CFB documents, saved display-cache tessellation, native styles, sheet-metal parameters, PMI inventories, properties, saved views, feature names, selection provenance, model bounds and Parasolid payload metadata |
