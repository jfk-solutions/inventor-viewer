...
The minified browser runtime and application build include the following open-source software:

| Package | Version | License |
| --- | ---: | --- |
| `@jfk-solutions/inventor-file-format` | 0.1.0 | MIT |
| `@jfk-solutions/creo-file-format` | 0.1.0 | MIT |
| `@jfk-solutions/solidedge-file-format` | 0.1.0 | MIT |
| `@jfk-solutions/simaticnx-file-format` | 0.1.0 | MIT |
...
| `@jfk-solutions/step-file-format` | 0.1.0 | MIT |
...
The PTC Creo reader's MIT license and notices are distributed at `public/vendor/licenses/creo-file-format-LICENSE` and `public/vendor/licenses/creo-file-format-NOTICES.md`.

The Siemens Solid Edge reader's MIT license is distributed at `public/vendor/licenses/solidedge-file-format-LICENSE`.

The Siemens NX reader's MIT license and attribution for the JT decoder implementation are distributed at `public/vendor/licenses/simaticnx-file-format-LICENSE` and `public/vendor/licenses/simaticnx-file-format-NOTICES.md`.

The unpublished STEP reader and tessellator is distributed as the dedicated minified `public/vendor/step-file-format.worker.min.js` browser worker. Its MIT license is distributed at `public/vendor/licenses/step-file-format-LICENSE`.
